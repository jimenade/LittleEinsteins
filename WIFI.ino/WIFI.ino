...
const char *ssid =  "wifieif";   // name of your WiFi network
const char *password =  "Goox0sie_WZCGGh25680000"; // password of the WiFi network
...
IPAddress broker(193,147,53,2); // IP address of your MQTT broker eg. 192.168.1.50
WiFiClient wclient;
